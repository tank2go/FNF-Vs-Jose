...
class PlayState extends MusicBeatState
{
	...
	public static var STRUM_X_MIDDLESCROLL = 42;
	...
	override public function create()
	{
		...
		if(!modchartSprites.exists('blammedLightsBlack')) { //Creates blammed light black fade in case you didn't make your own
			blammedLightsBlack = new ModchartSprite(FlxG.width * -0.9, FlxG.height * -0.9);
			blammedLightsBlack.makeGraphic(Std.int(FlxG.width * 9), Std.int(FlxG.height * 9), FlxColor.BLACK);
		...
		Watermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " - " + (storyDifficultyText) + (" | Vs Jose v" + MainMenuState.joseVersion), 16);
	...
	public function startCountdown():Void
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
			{
				...
				introAssets.set('default', ['pixelUI/ready', 'pixelUI/set', 'pixelUI/go']);
				introAssets.set('pixel', ['pixelUI/ready', 'pixelUI/set', 'pixelUI/go']);
