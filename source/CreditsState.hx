...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		['Vs Jose'],
		['Tank2go', 'tank', 'Creator of the mod', 'https://www.youtube.com/channel/UCuDIoogO2mIthppMH8UpxHQ', '0xFF008000'],
		['FunkyGamer', 'funkygamer', 'Original creator of Jose', 'https://mobile.twitter.com/YtGamerthebot', '0xFFFF0000'],
		['Extra Keys Port'],
